...
Command: npx gltfjsx@6.5.2 ./public/models/IPhone13.glb 
...
export function Iphone13Model(props) {
  const { nodes, materials } = useGLTF('./models/IPhone13.glb')
  const wallpaperTexture = useTexture('/Screenshots/ForIphone.png')
  return (
...
useGLTF.preload('./models/IPhone13.glb')
